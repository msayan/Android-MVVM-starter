...
shutil.move('ExampleInstrumentedTest.kt', package_dir + '/ExampleInstrumentedTest.kt')
...
core = os.path.join(root_src_dir,"core")
di = os.path.join(root_src_dir,"di")
net = os.path.join(root_src_dir,"net")
...
moverecursively(core,root_dst_dir)
moverecursively(di,root_dst_dir)
moverecursively(net,root_dst_dir)
